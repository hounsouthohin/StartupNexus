...
export type { Category, Recipe } from '@prisma/client'
...
export type SerializedCategory = {
  id: string
  name: string
  recipes?: { id: string; title: string; description: string; slug: string; status: "draft" | "published" | "archived"; categoryId: string; authorId: string; createdAt: string }[]
  createdAt: string
}
