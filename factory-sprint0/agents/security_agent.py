"""Superviseur Sécurité inline (Sprint 4.6 v2)."""
...
def _load_system_prompt(stack_id: str) -> str:
    base = load_base_prompt("security")
    rules = load_stack_rules_only("security", stack_id)
...
async def run_security_supervisor(
    ...
    try:
        ...
        logger.warning(f"[security_supervisor] skipped (non bloquant): {e}")
