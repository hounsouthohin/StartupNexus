...
from agents.shared_tools import run_tests, write_file, get_stack_id, _load_stack_template
...
def generation_node(state: AgentState) -> dict:
    ...
    try:
        state["files"]["tsconfig.json"] = _load_stack_template("tsconfig.json", stack_id)
        state["files"]["jest.config.js"] = _load_stack_template("jest.config.js", stack_id)
        state["files"][".babelrc"] = _load_stack_template(".babelrc", stack_id)
    except Exception as e:
        logger.warning(f"Templates de test indisponibles pour stack '{stack_id}': {e}")
