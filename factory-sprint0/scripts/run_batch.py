...
BATCH_PROJECTS: List[Dict[str, Any]] = get_batch_projects(4)
...
def _compact_run_metric(metric: Dict[str, Any]) -> Dict[str, Any]:
    ...
    compact = {
        ...
        "requirements_unmet": metric.get("requirements_unmet"),
        "requirements_unknown": metric.get("requirements_unknown"),
    ...
    if activity_name == "dev_test_activity":
        ...
        return {
            ...
            "metadata": {
                ...
                "requirements_unknown": metadata.get("requirements_unknown"),
