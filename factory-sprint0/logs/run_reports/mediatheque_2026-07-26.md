# FactoryRunReport — mediatheque — 2026-07-26
══════════════════════════════════════════════════

🔗 APP LIVE : http://localhost:3100

CE QUE L'APP FAIT :
  L'application permet aux visiteurs de parcourir le catalogue public des ouvrages sans se connecter. Chaque ouvrage affiche son titre, auteur, résumé, genre et année de publication. Les adhérents peuvent se connecter pour gérer leur profil et demander à emprunter des ouvrages. Un emprunt passe par plusieurs états : demandé, accepté, refusé, et rendu. Les adhérents ne voient que leurs propres emprunts, tandis que le bibliothécaire peut voir et gérer tous les emprunts, y compris accepter, refuser ou marquer un emprunt comme rendu.
...
RUN_ID       : 18fa4670-a6b1-481c-95ad-566c62d72547
DURÉE        : 1min 37s