# FactoryRunReport — personal-blog — 2026-06-18
══════════════════════════════════════════════════
BUILD        : ❌ SUCCESS
REVIEW       : COHERENT | sec=100 | coh=100 | 0 finding(s)
CORRECTIONS  : SKIPPED (NOT_RUN)
TESTS        : ✗ 2 test(s) — FAIL tests/services.test.ts | PASS tests/schemas.test.ts | T
SEMGREP      : ⚠ 2 finding(s)
...
RUN_ID       : e5b2fb60-34dd-4111-b078-cef87cd715a9
DURÉE        : 3min 10s