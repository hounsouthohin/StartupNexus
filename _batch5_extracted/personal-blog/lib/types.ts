...
export type SerializedPost = {
  ...
  categoryId: string
  category?: { id: string; name: string; authorId: string; createdAt: string }
  createdAt: string
}
...
export type SerializedCategory = {
  id: string
  name: string
  posts?: { id: string; title: string; excerpt: string; status: "draft" | "published"; categoryId: string; authorId: string; createdAt: string }[]
  createdAt: string
}
