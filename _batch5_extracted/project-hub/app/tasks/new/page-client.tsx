...
interface TasksNewClientProps {
  projectOptions: SerializedProject[]
}

export default function TasksNewClient({ projectOptions }: TasksNewClientProps) {
  ...
  return (
    <main className="container mx-auto p-6 max-w-xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Nouveau Task</h1>
      </div>
